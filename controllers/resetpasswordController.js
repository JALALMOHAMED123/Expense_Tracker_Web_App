        ...
        if (user) {
            ...
            transactionalEmailApi
                .sendTransacEmail({
                    ...
                    htmlContent: `<a href="http://52.21.159.88:3000/password/resetpassword/${id}">Reset password</a>`,
                })
                .then((response) => {
    ...
    Forgotpassword.findOne({ where : { id }}).then(forgotpasswordrequest => {
        if(forgotpasswordrequest){
            ...
            res.status(200).send(`<html>
                                    ...
                                    <form action="http://52.21.159.88:3000/password/updatepassword/${id}" method="get">
